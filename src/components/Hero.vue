<template>
  <div
    class="hero min-h-screen z-0 relative"
    style="
    ...
    "
  >
    <div class="hero-overlay bg-opacity-60 w-full bg-black backdrop-blur-sm">
      <div
        class="
          hero-content
          text-black
    ...
    <!-- <img
      src="../assets/white-wave.svg"
      class="w-full bottom-0 left-0 absolute"
    /> -->
  </div>
</template>
