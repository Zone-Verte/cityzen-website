<template>
        ...
        <div class="lg:px-20  lg:flex  rounded-2xl lg:gap-20">
            <div class="h-48  lg:h-auto lg:w-[50%] flex-none bg-cover rounded-t lg:rounded-bl-[100px] lg:rounded-tr-[100px] text-center overflow-hidden"
                style="background-image: url(meeting.jpg)"
                title="">
            </div>
            <div
                class=" pt-10 h-full lg:border-gray-400 bg-primary text-neutral-content rounded-b lg:rounded-br-[100px] lg:rounded-tl-[100px] p-4 lg:pl-16 px-12 lg:px-4 flex flex-col justify-between leading-normal">
                <div class="mb-8" >
